...
class MainViewModel(context: Context): ViewModel() {
    ...
    private val loginStatusLiveData: MutableLiveData<LoginStatus> = MutableLiveData<LoginStatus>().apply {
...
//        currentUser = auth.currentUser!!
    ...
    /* Below function is used to register a new user in database. It takes email and password as
       ...
       successful, it will return true, else it will return false. Based on the returned value,
    ...
    /* Below function is used to sign in user using Firebase Auth. It takes email and password as
       parameters and sign in using them. If sign in is successful, it will return true,
       else it will return false. Based on the returned value, UI is updated and respective toast
       is showed to user.
     */
